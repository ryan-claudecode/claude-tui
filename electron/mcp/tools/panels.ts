...
export function registerPanelTools(
  ...
  server.tool(
    ...
    {
      type: z.enum(["diff", "image", "markdown", "table", "test", "chart", "tree", "timeline", "git", "kanban", "notes", "stat", "log", "progress", "code", "heatmap", "mission", "worktree-review"]).describe("Panel type"),
